...
public class DateApplication {
    ...
    ResourceBundle messages = ResourceBundle.getBundle("com.example.database.MessagesBundle", Locale.US);
    Date today = new Date();
    DateFormat df;
    ...
    public void run(){
        ...
        while (!(line.equals("q"))){
            ...
            switch (line){
                case "1": this.setEnglish();
                break;
                case "2": this.setFrench();
                break;
                case "3": this.setItalian();
                break;
                case "4": this.setChinese();
                break;
                case "5": this.setGerman();
                break;
            }
        }
    }
    ...
    public void setEnglish(){
        ...
        messages = ResourceBundle.getBundle("com.example.database.MessagesBundle",currentLocale);
    }
    ...
    public void setGerman(){
        ...
        this.messages = ResourceBundle.getBundle("com.example.database.MessagesBundle", currentLocale);
    }
}
